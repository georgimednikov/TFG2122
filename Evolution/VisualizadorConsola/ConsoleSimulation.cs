        ...
        public void Render()
        {
            ...
            for (int i = 0; i < world.map.GetLength(0); i++)
            {
                for (int j = 0; j < world.map.GetLength(1); j++)
                {
                    ...
                    //heightMap.SetPixel(j, i, Color.FromArgb((int)((val) * 255), (int)((val) * 255), (int)((val) * 255)));
                ...
                for (int j = 0; j < world.map.GetLength(1); j++)
                {
                    ...
                    //hMap.SetPixel(j, i, Color.FromArgb((int)((1-val/2) * 255), 0, (int)((val) * 255)));
                ...
                for (int j = 0; j < world.map.GetLength(1); j++)
                {
                    ...
                    //tempMap.SetPixel(j, i, Color.FromArgb((int)((val) * 255), 0, (int)((1-val) * 255)));
                ...
                for (int j = 0; j < world.map.GetLength(1); j++)
                {
                    ...
                    //floraMap.SetPixel(j, i, Color.FromArgb((int)((1-val) * 255), (int)((val) * 255), 0));
                    ...
                    //else treeMap.SetPixel(j, i, Color.Black);
