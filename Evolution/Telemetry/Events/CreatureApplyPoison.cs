...
namespace Telemetry.Events
{
    public class CreatureApplyPoison : CreatureEvent
    {
        ...
        public CreatureApplyPoison(int tick, int creatureID, string speciesName, int vID, string vSp, float dmg, int dur) : base(EventType.CreatureAttack, tick, creatureID, speciesName) 
