...
#if TRACKER_ENABLED
            Tracker.Instance.Track(new CreatureDeath(creature.world.CurrentTick, creature.ID, creature.speciesName, (DeathType)creature.causeOfDeath, creature.killerID, creature.killingBlow, creature.x, creature.y));
#endif         
            // Set cause of death
